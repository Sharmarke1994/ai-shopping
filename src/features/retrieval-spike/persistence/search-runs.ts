...
function stripPersistedListing(
  ...
  return {
    ...
    merchantDestinationUrl: listing.merchantDestinationUrl,
    merchantDestinationSource: listing.merchantDestinationSource,
      ...
      return persisted({
        ...
        parse: () =>
          persistedCandidateListingSchema.parse({
            ...
            merchantDestinationUrl: row.merchantDestinationUrl,
            merchantDestinationSource: row.merchantDestinationSource,
