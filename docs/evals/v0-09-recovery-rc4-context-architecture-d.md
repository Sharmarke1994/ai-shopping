# V0-05 context-hardening diagnostic (architecture-d)

This is one bounded Terra diagnostic batch, not V0-05 release acceptance.

- Model: gpt-5.6-terra (reasoning low)
- Logical interpretation calls: 19
- Proposal-blind inventory calls: 0; mapped interpretation calls: 0
- Coverage checks: 0; repairs: 0
- Logical action calls: 0
- Cases: 19; completed: 0; failed: 19
- Protected semantic violations: 55

## architecture-d-ergonomic-mouse-1
...
- criteria: none
## architecture-d-ergonomic-mouse-2

- status: failed
- action: none
- violations: sculpted profile preference was lost; parent preference was lost; subordinate condition silently disappeared from state, ambiguity, and question; review importance was not preserved as strong preference
- criteria: none
## architecture-d-ergonomic-mouse-3

- status: failed
- action: none
- violations: sculpted profile preference was lost; parent preference was lost; subordinate condition silently disappeared from state, ambiguity, and question; review importance was not preserved as strong preference
- criteria: none
## architecture-d-ergonomic-mouse-4

- status: failed
- action: none
- violations: sculpted profile preference was lost; parent preference was lost; subordinate condition silently disappeared from state, ambiguity, and question; review importance was not preserved as strong preference
- criteria: none
## architecture-d-ergonomic-mouse-5

- status: failed
- action: none
- violations: sculpted profile preference was lost; parent preference was lost; subordinate condition silently disappeared from state, ambiguity, and question; review importance was not preserved as strong preference
- criteria: none
## architecture-d-ergonomic-mouse-6

- status: failed
- action: none
- violations: sculpted profile preference was lost; parent preference was lost; subordinate condition silently disappeared from state, ambiguity, and question; review importance was not preserved as strong preference
- criteria: none
## architecture-d-ergonomic-mouse-7

- status: failed
- action: none
- violations: sculpted profile preference was lost; parent preference was lost; subordinate condition silently disappeared from state, ambiguity, and question; review importance was not preserved as strong preference
- criteria: none
## architecture-d-ergonomic-mouse-8
...
- status: failed
- action: none
- violations: contextual comfort was not preserved as strong_preference
- criteria: none
## cap-golden
...
- status: failed
- action: none
- violations: cordless vacuum context acquisition did not complete
- criteria: none
## compact-coffee-machine

- status: failed
- action: none
- violations: compact coffee-machine context acquisition did not complete
- criteria: none
